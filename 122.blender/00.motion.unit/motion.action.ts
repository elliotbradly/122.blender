...
export const DEV_MOTION = "[Motion action] Dev Motion";
export class DevMotion implements Action {
 readonly type = DEV_MOTION;
 constructor(public bale: MotionBit) {}
}

export type Actions = | InitMotion | UpdateMotion | DevMotion;
